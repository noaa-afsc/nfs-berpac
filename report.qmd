...
ggplot() +
  ...
  ylab("depth (meters)") +
  labs(title = "San Miguel Island, CA",
       subtitle = "each bar represents an 8-hour window for a single upcast",
       caption = stringr::str_wrap("data derived from the onboard thermister and transmitted as temperature at depths based on the World Ocean Database 2013 specification")) +
  theme_minimal() +
  theme(legend.position = "bottom")
